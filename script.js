        ...
        function renderMembers() {
            ...
            if (faculty.length > 0) {
                ...
                mentorsGrid.innerHTML = faculty.map((m, i) => {
                    ...
                    return `
                    <div class="mentor-card bg-white dark:bg-brand-card rounded-2xl p-6 flex flex-col items-center text-center border border-gray-100 dark:border-gray-800 reveal group w-full max-w-[320px] ${hasLink ? 'has-link cursor-pointer' : ''}" 
